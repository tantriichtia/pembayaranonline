...
class _BayarPageState extends State<BayarPage> {
  ...
  Future<void> fetchData() async {
    final Uri url = Uri.parse(
        'http://localhost/tantri/tripay/bayar.php?nisn=${widget.nisn}&amount=${widget.amount}&paymentMethodCode=${widget.paymentMethodCode}&title=${widget.title}');
  ...
  void konfirmasiPembayaran() async {
    if (responseData != null) {
      final url = Uri.parse(
          'http://localhost/tantri/tripay/trx.php?trx=${responseData!['data']['reference']}');
      final response = await http.get(url);
